...
# Next: Generate datasets for each distributional scenario. The datasets are generated twice so they are the same as those in the first manuscript.
# ==============================================================================
set.seed(1234)
...
not_used_dat_lognormal <- cbind(x, y)
...
img_paths <- c(
  paste0("./figures/simu_normal_mixture/normal_mixture_center_hdepth_sub", 1:6, ".png"),
  paste0("./figures/simu_log_normal/log_normal_center_hdepth_sub", 1:6, ".png")
)
...
ggsave(
  filename = file.path(save_dir, paste0("comp_chisq_F_simu.png")),
  plot = combined,
